...
Vue.component('WxFooter', Footer)
Vue.component('WxProjects', Projects)
Vue.component('WxSkillset', Skillset)
Vue.component('WxExperience', Experience)
Vue.component('WxEducation', Education)
Vue.component('WxContact', Contact)
Vue.component('WxSkill', Skill)
Vue.component('WxSocialicons', Socialicons)
